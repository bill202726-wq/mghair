...
export default function Login({ onLogin, onBack }: LoginProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if ((cleanEmail === 'admin@aapi.dz' || cleanEmail === 'mghair@aapi.dz') && (cleanPassword === 'mghair@aapi.dz' || cleanPassword === 'admin')) {
      onLogin('agent');
    } else if (cleanEmail === 'superadmin@aapi.dz' && (cleanPassword === 'superadmin' || cleanPassword === 'mghair@aapi.dz')) {
      onLogin('superadmin');
    } else {
