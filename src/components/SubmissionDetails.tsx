          ...
          <div className="grid grid-cols-1 md:grid-cols-2 print:grid-cols-2 gap-8 print:gap-4">
            ...
            <section className="print:break-inside-avoid">
              ...
              <div className="space-y-3 print:space-y-1">
                ...
                {submission.contactEtabli === 'telephone' && submission.informationPromoteur && (
                  <DetailItem label="Information Promoteur" value={submission.informationPromoteur === 'autre' ? submission.informationPromoteurAutre : submission.informationPromoteur?.replace(/_/g, ' ')} />
                )}
                {submission.contactEtabli === 'non' && submission.raisonNonContact && (
                  <DetailItem label="Raison Non Contact" value={submission.raisonNonContact === 'autre' ? submission.raisonNonContactAutre : submission.raisonNonContact?.replace(/_/g, ' ')} />
                )}
              </div>
            </section>
